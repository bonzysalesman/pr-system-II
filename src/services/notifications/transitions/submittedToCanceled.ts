...
/**
 * Handles the transition from SUBMITTED to CANCELED status
 */
export class SubmittedToCanceledHandler implements StatusTransitionHandler {
  /**
      ...
      <div style="padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tr>
            ...
            <td style="padding: 8px; border: 1px solid #ddd;">SUBMITTED → CANCELED</td>
          </tr>
          ${context.notes ? `
          <tr>
...
Status Change: SUBMITTED → CANCELED
