...
/**
 * Handles the transition from ORDERED to PARTIALLY_RECEIVED status
 */
export class OrderedToPartiallyReceivedHandler implements StatusTransitionHandler {
  /**
  ...
  async getEmailContent(context: NotificationContext): Promise<EmailContent> {
    ...
    const subject = `${urgentPrefix}PR #${context.prNumber} Partially Received`;
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background-color: #f8f8f8; padding: 20px; border-bottom: 3px solid #e0e0e0;">
        <h2 style="margin: 0; color: #333;">PR #${context.prNumber} Items Partially Received</h2>
      </div>
      
      <div style="padding: 20px;">
        <p>Some items for this purchase request have been received. Updated by ${changedByUser}.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tr>
            ...
            <td style="padding: 8px; border: 1px solid #ddd;">ORDERED → PARTIALLY_RECEIVED</td>
          </tr>
          ${context.notes ? `
          <tr>
...
PR #${context.prNumber} Items Partially Received

Some items for this purchase request have been received. Updated by ${changedByUser}.
...
Status Change: ORDERED → PARTIALLY_RECEIVED
